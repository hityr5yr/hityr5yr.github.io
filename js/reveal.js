...
//  		window.addEventListener('orientationchange', doOnOrientationChange);
	...
	function setupDOM() {
		...
		//Menu arrow
		dom.slideNumber = createSingletonNode( dom.wrapper, 'div', 'meny-arrow', '' );
...
//		slide( slideIndex ); // Changed by Peter Petrov
	...
	function onOrientationChange( event ) {							// 
	    switch(window.orientation){  								// 
	      ...
	      default:																												// 
	      	for(var i=0; i<=document.querySelectorAll(".reveal section.present a.navigate-down.arrow.enabled").length - 1; i++){// 
	        	document.querySelectorAll(".reveal section.present a.navigate-down.arrow.enabled")[i].style.display = "inline-block";// 
	   		 }																													// 
	      	for(var i=0; i<=document.querySelectorAll(".reveal .quest").length - 1; i++){										// 
